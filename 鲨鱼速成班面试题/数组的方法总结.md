...
## 小知识点
    ...
    []==0    true     // []转成数字是0
    [undefined]==false   true  // [undefined].toString() = ''
    [null]==false   true   // [undefined].toString() = ''
...
返回一个新的Array迭代器对象,该对象包含数组中每个索引的键/值对。可用for...of遍历(不改变原数组)\
语法：arr.entries()
...
## 反向遍历数组
    ...
    varfor(let i=arr.length-1;i>=0;i--){
