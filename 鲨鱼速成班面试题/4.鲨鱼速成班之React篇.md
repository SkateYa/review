...
1. 初始化阶段: 由ReactDOM.render()触发---初次渲染
                    ...
                    2.  shouldComponentUpdate()  (为true继续执行后面的生命周期，false中断不执行后面的)
                    3.  render()
...
componentDidMount   组件挂载完成,一般用来做一些页面初始化操作,比如初始请求, echart绘制等,也就是vue的mounted里能做的事
...
componentwillUnmount   组件即将卸载,通常做一些全局事件的监听的卸载,定时器,计时器的卸载,来优化性能
...
### 9. Redux 和 Vuex 有什么区别，它们的共同思想--了解即可
