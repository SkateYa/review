...
<div style="border:1px solid black;width:430px;height:1000px;float:left;margin-right:20px;"><strong>vue2.x的生命周期</strong><img src="https://v2.cn.vuejs.org/images/lifecycle.png" alt="lifecycle_2" style="zoom:35%;width:1700px" /></div><div style="border:1px solid black;width:510px;height:1000px;float:left"><strong>vue3.0的生命周期</strong><img src="https://cn.vuejs.org/assets/lifecycle_zh-CN.FtDDVyNA.png" alt="lifecycle_2" style="zoom:34%;width:2500px" /></div>
